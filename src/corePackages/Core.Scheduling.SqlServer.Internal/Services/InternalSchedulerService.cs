...
public class InternalSchedulerService : IInternalSchedulerService
{
    ...
    private readonly SqlServerInternalMessageDbContext _internalMessageDbContext;
    ...
    IMediator mediator,
    SqlServerInternalMessageDbContext internalMessageDbContext,
    ...
    public async Task<IEnumerable<InternalMessage>> GetAllInternalMessagesAsync(CancellationToken cancellationToken = default)
    {
        var messages =
    ...
    public async Task<IEnumerable<InternalMessage>> GetAllUnsentInternalMessagesAsync(CancellationToken cancellationToken = default)
    {
